...
namespace jbindgen {
    ...
    std::string getNPtrListContent() {
        return "\n"
               ...
               "    }\n"
               "\n"
               "    public NPtrList(Pointer<Pointer<T>> ptr, Arena arena, Consumer<Pointer<Pointer<T>>> cleanup, Function<Pointer<T>, T> constructor, long elementByteSize, long length) {\n"
               "        this(ptr.pointer().reinterpret(length * ValueLayout.ADDRESS.byteSize(), arena, memorySegment -> cleanup.accept(() -> memorySegment)), constructor, elementByteSize);\n"
               "    }\n"
               "\n"
               "    public NPtrList(Pointer<Pointer<T>> ptr, Arena arena, Consumer<Pointer<Pointer<T>>> cleanup, Function<Pointer<T>, T> constructor, long[] elementsByteSize) {\n"
               "        this(ptr.pointer().reinterpret(elementsByteSize.length * ValueLayout.ADDRESS.byteSize(), arena, memorySegment -> cleanup.accept(() -> memorySegment)), constructor, elementsByteSize);\n"
               "    }\n"
               "\n"
               "    public NPtrList(Pointer<Pointer<T>> ptr, Arena arena, Consumer<Pointer<Pointer<T>>> cleanup, Function<Pointer<T>, T> constructor, long elementByteSize) {\n"
               "        this(ptr.pointer().reinterpret(arena, memorySegment -> cleanup.accept(() -> memorySegment)), constructor, elementByteSize);\n"
               "    }\n"
               "\n"
    ...
    std::string getNStringContent(const std::string &vi8ValuePackageName) {
        return "\n"
               ...
               "        this(ptr.pointer().reinterpret(byteSize, arena, cleanup));\n"
               "    }\n"
               "\n"
               "    public NString(Arena arena, String s) {\n"
               "        this(arena.allocateFrom(s, StandardCharsets.UTF_8));\n"
               "    }\n"
               "\n"
