...
namespace jbindgen {
    ...
    std::string getVListContent() {
        return "\n"
               ...
               "import java.util.function.Function;\n"
               "\n"
               "public class VList<V, T extends Value<V>> extends AbstractNativeList<T> {\n"
               ...
               "    }\n"
               "\n"
               "    public VList(Arena arena, long length, Function<MemorySegment, T> constructor, BiConsumer<Long, VList<V, T>> creator, long byteSize) {\n"
               ...
               "\n"
               "    @Override\n"
               "    public VList<V, T> subList(int fromIndex, int toIndex) {\n"
               "        subListRangeCheck(fromIndex, toIndex, size());\n"
    ...
    std::string getValueContent(std::string className, std::string baseObjectType, std::string valueLayout,
        ...
        return std::vformat(
                ...
                "\n"
                "    public static VList<{1}, {0}> list(MemorySegment ptr) {{\n"
                "        return new VList<>(ptr, {0}::new, BYTE_SIZE);\n"
                "    }}\n"
                "\n"
                "    public static VList<{1}, {0}> list(MemorySegment ptr, long length) {{\n"
                "        return new VList<>(ptr, length, {0}::new, BYTE_SIZE);\n"
                "    }}\n"
                "\n"
                "    public static VList<{1}, {0}> list(MemorySegment ptr, long length, Arena arena, Consumer<MemorySegment> cleanup) {{\n"
                "        return new VList<>(ptr, length, arena, cleanup, {0}::new, BYTE_SIZE);\n"
                "    }}\n"
                "\n"
                "    public static VList<{1}, {0}> list(Arena arena, long length) {{\n"
                "        return new VList<>(arena, length, {0}::new, BYTE_SIZE);\n"
                "    }}\n"
                "\n"
                "    public static VList<{1}, {0}> list(Arena arena, {1}[] c) {{\n"
                "        return new VList<>(arena, c, {0}::new, BYTE_SIZE);\n"
                "    }}\n"
                "\n"
                "    public static VList<{1}, {0}> list(Arena arena, Collection<{1}> c) {{\n"
                "        return new VList<>(arena, c.size(), {0}::new, BYTE_SIZE);\n"
                "    }}\n"
                "\n"
                "    public static VList<{1}, {0}> list(Arena arena, {0}[] c) {{\n"
                "        return new VList<>(arena, c, (Function<MemorySegment, {0}>) {0}::new, BYTE_SIZE);\n"
                "    }}\n"
                "\n"
                "    public static VList<{1}, {0}> list(Arena arena, List<{0}> c) {{\n"
                "        return new VList<>(arena, c.size(), {0}::new, BYTE_SIZE);\n"
                "    }}\n"
                "\n"
