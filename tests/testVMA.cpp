...
int main() {
    const char *args_vk[] = {"-I", "/usr/include", "-I", TEST_SRC_DIR"/../../../vulkan/src/vulkan-src/include/"};
    ...
    const char *args[] = {"-I", "/usr/include", "-I", TEST_SRC_DIR"/../../../vulkan/src/vulkan-src/include/"};
    jbindgen::Analyser vma_analysed(
            jbindgen::defaultAnalyserConfig(TEST_SRC_DIR"/include/vk_mem_alloc.h", args, 4));
